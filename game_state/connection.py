...
import logging
import time
from urllib2 import (OpenerDirector, UnknownHandler, HTTPHandler, HTTPDefaultErrorHandler, HTTPErrorProcessor, HTTPCookieProcessor, HTTPError, HTTPRedirectHandler, HTTPSHandler)
...
class Connection(object):
    ...
    def __getResponseNoRedirect(self, data, cookies=None, headers=None):
        ...
        h_classes = [UnknownHandler, HTTPHandler, HTTPDefaultErrorHandler, HTTPErrorProcessor, HTTPSHandler]
    ...
    def getHeaders(self):
        return {'User-Agent': 'Mozilla/5.0 (Windows NT 5.1; rv:44.0) Gecko/20100101 Firefox/44.0',
                'Host': '95.163.80.22',
                # 'Host': 'auth.mail.ru',
