...
from game_state.game_types import GameDiggerGrave, GameDiggerGraveWithBrains,\
    GamePickItem, GameGainItem, GamePickup #, GameStargazer, GameStargazerCash
...
class BagsPicker(ResourcePicker):
    ...
    def get_worker_types(self):
        return [GameDiggerGrave.type, GameDiggerGraveWithBrains.type] # GameStargazer.type, GameStargazerCash.type
